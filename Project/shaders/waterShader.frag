...
void main() 
{
	...
	if(compareVec3(directionalLightColor,vec3(0.36,0.17,0.015))>3 && compareVec3(directionalLightColor,vec3(0.37,0.19,0.02))>3) // 5c2d04
	{
		shadowConstant = 2.0;
	}
	else if(compareVec3(directionalLightColor,vec3(0.9,0.88,0.77))>3) // ffe4c9
	{
		shadowConstant = 4.0;
	}
	////////////////////////////////////////////////////////////
